::namespace eval ::pct::build {
  ...
  proc callback {args} {
    ...
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/RAID2/COURSE/mlchip/mlchip098/lab1/lab1_mac/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
