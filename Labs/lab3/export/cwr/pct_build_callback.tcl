::namespace eval ::pct::build {
  ...
  proc callback {args} {
    ...
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/home/2024MLChip/mlchip098/lab3/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
