...
int sc_main( int argc, char* argv[] ) {
	...
	sc_buffer < bool > in_valid;
	sc_buffer < bool > conv1_valid;
	sc_buffer < bool > mp1_valid;
	sc_buffer < bool > conv2_valid;
	sc_buffer < bool > mp2_valid;
	sc_buffer < bool > conv3_valid;
	sc_buffer < bool > conv4_valid;
	sc_buffer < bool > conv5_valid;
	sc_buffer < bool > mp3_valid;
	sc_buffer < bool > linear1_valid;
	sc_buffer < bool > linear2_valid;
	sc_buffer < bool > linear3_valid;

	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > image{"image", 150528};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > conv1_result{"conv1_result", 193600};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > mp1_result{"mp1_result", 46656};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > conv2_result{"conv2_result", 139968};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > mp2_result{"mp2_result", 32448};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > conv3_result{"conv3_result", 64896};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > conv4_result{"conv4_result", 43264};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > conv5_result{"conv5_result", 43264};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > mp3_result{"mp3_result", 9216};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > linear1_result{"linear1_result", 4096};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > linear2_result{"linear2_result", 4096};
	sc_vector < sc_buffer < sc_fixed_fast<45,17> > > linear3_result{"linear3_result", 1000};
