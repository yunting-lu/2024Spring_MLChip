...
int sc_main( int argc, char* argv[] ) {
	...
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > conv1_result{"conv1_result", 193600};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > mp1_result{"mp1_result", 46656};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > conv2_result{"conv2_result", 139968};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > mp2_result{"mp2_result", 32448};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > conv3_result{"conv3_result", 64896};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > conv4_result{"conv4_result", 43264};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > conv5_result{"conv5_result", 43264};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > mp3_result{"mp3_result", 9216};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > linear1_result{"linear1_result", 4096};
	sc_vector < sc_signal < sc_fixed_fast<45,17> > > linear2_result{"linear2_result", 4096};
